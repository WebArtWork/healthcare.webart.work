...
export class HomeComponent {
	...
	readonly features: HomeFeature[] = [
		...
		},
		{
			...
			description:
				'Знаходьте об’єкти, заклади та мережі за розташуванням — з фільтрами під ваш запит.',
		},
		{
			icon: 'pi pi-building',
			title: 'Агенції та агенти',
			description:
				'Профілі відділень, мереж і лікарів поруч із кожним об’єктом — зрозуміло, хто відповідає за угоду.',
		},
	];
}
