...
export class ForUsersPageComponent {
	...
	readonly faq = [
		...
		},
		{
			...
			answer: 'Кожен об’єкт має цифровий паспорт з історією ремонтів, обслуговування та перевіреними даними від відділень і мереж.',
		},
		{
			question: 'Чи можу я зв’язатися напряму з власником або агентом?',
			answer: 'Так, контакти лікаря, відділення або мережі доступні прямо на сторінці оголошення.',
		},
	];
}
